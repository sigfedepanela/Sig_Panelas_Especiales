...
jsonSource_PreciosPanelasEspeciales_2.addFeatures(features_PreciosPanelasEspeciales_2);var lyr_PreciosPanelasEspeciales_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/PreciosPanelasEspeciales_2_0.png" />  1565 - 1692 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_1.png" />  1692 - 1819 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_2.png" />  1819 - 1946 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_3.png" />  1946 - 2073 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_4.png" />  2073 - 2200 <br />'
...
jsonSource_MunicipiosTomadePrecios_3.addFeatures(features_MunicipiosTomadePrecios_3);var lyr_MunicipiosTomadePrecios_3 = new ol.layer.Vector({
            ...
            });var format_PreciosCuartaSemanadeAgostode2019_4 = new ol.format.GeoJSON();
var features_PreciosCuartaSemanadeAgostode2019_4 = format_PreciosCuartaSemanadeAgostode2019_4.readFeatures(json_PreciosCuartaSemanadeAgostode2019_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PreciosCuartaSemanadeAgostode2019_4 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_PreciosCuartaSemanadeAgostode2019_4.addFeatures(features_PreciosCuartaSemanadeAgostode2019_4);var lyr_PreciosCuartaSemanadeAgostode2019_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosCuartaSemanadeAgostode2019_4, 
                style: style_PreciosCuartaSemanadeAgostode2019_4,
                title: '<img src="styles/legend/PreciosCuartaSemanadeAgostode2019_4.png" /> Precios Cuarta Semana de Agosto de 2019'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_LimiteDepartamental_1.setVisible(true);lyr_PreciosPanelasEspeciales_2.setVisible(true);lyr_MunicipiosTomadePrecios_3.setVisible(true);lyr_PreciosCuartaSemanadeAgostode2019_4.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_LimiteDepartamental_1,lyr_PreciosPanelasEspeciales_2,lyr_MunicipiosTomadePrecios_3,lyr_PreciosCuartaSemanadeAgostode2019_4];
...
lyr_PreciosCuartaSemanadeAgostode2019_4.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_PreciosCuartaSemanadeAgostode2019_4.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_PreciosCuartaSemanadeAgostode2019_4.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_PreciosCuartaSemanadeAgostode2019_4.on('precompose', function(evt) {
