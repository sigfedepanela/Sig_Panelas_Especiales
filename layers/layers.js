...
jsonSource_PreciosPanelasEspeciales_2.addFeatures(features_PreciosPanelasEspeciales_2);
var lyr_PreciosPanelasEspeciales_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosPanelasEspeciales_2, 
                style: style_PreciosPanelasEspeciales_2,
                interactive: true,
    title: 'Precios Panelas Especiales<br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_0.png" />  1650 - 1780 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_1.png" />  1780 - 1910 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_2.png" />  1910 - 2040 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_3.png" />  2040 - 2170 <br />\
    <img src="styles/legend/PreciosPanelasEspeciales_2_4.png" />  2170 - 2300 <br />'
        });
...
var format_PreciosSegundaSemanadeNoviembrede2019_4 = new ol.format.GeoJSON();
var features_PreciosSegundaSemanadeNoviembrede2019_4 = format_PreciosSegundaSemanadeNoviembrede2019_4.readFeatures(json_PreciosSegundaSemanadeNoviembrede2019_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PreciosSegundaSemanadeNoviembrede2019_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PreciosSegundaSemanadeNoviembrede2019_4.addFeatures(features_PreciosSegundaSemanadeNoviembrede2019_4);
var lyr_PreciosSegundaSemanadeNoviembrede2019_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosSegundaSemanadeNoviembrede2019_4, 
                style: style_PreciosSegundaSemanadeNoviembrede2019_4,
                interactive: true,
                title: '<img src="styles/legend/PreciosSegundaSemanadeNoviembrede2019_4.png" /> Precios Segunda Semana de Noviembre de 2019'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_LimiteDepartamental_1.setVisible(true);lyr_PreciosPanelasEspeciales_2.setVisible(true);lyr_MunicipiosTomadePrecios_3.setVisible(true);lyr_PreciosSegundaSemanadeNoviembrede2019_4.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_LimiteDepartamental_1,lyr_PreciosPanelasEspeciales_2,lyr_MunicipiosTomadePrecios_3,lyr_PreciosSegundaSemanadeNoviembrede2019_4];
...
lyr_PreciosSegundaSemanadeNoviembrede2019_4.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_PreciosSegundaSemanadeNoviembrede2019_4.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_PreciosSegundaSemanadeNoviembrede2019_4.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_PreciosSegundaSemanadeNoviembrede2019_4.on('precompose', function(evt) {
